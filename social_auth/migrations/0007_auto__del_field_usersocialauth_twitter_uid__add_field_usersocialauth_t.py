...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserSocialAuth.twitter_uid'
        db.delete_column('social_auth_usersocialauth', 'twitter_uid')

        # Adding field 'UserSocialAuth.twitter_id'
        db.add_column('social_auth_usersocialauth', 'twitter_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSocialAuth.twitter_access_token'
        db.add_column('social_auth_usersocialauth', 'twitter_access_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSocialAuth.facebook_id'
        db.add_column('social_auth_usersocialauth', 'facebook_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSocialAuth.facebook_extra_data'
        db.add_column('social_auth_usersocialauth', 'facebook_extra_data',
                      self.gf('social_auth.fields.JSONField')(default='{}', null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSocialAuth.facebook_access_token'
        db.add_column('social_auth_usersocialauth', 'facebook_access_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserSocialAuth.twitter_uid'
        db.add_column('social_auth_usersocialauth', 'twitter_uid',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserSocialAuth.twitter_id'
        db.delete_column('social_auth_usersocialauth', 'twitter_id')

        # Deleting field 'UserSocialAuth.twitter_access_token'
        db.delete_column('social_auth_usersocialauth', 'twitter_access_token')

        # Deleting field 'UserSocialAuth.facebook_id'
        db.delete_column('social_auth_usersocialauth', 'facebook_id')

        # Deleting field 'UserSocialAuth.facebook_extra_data'
        db.delete_column('social_auth_usersocialauth', 'facebook_extra_data')

        # Deleting field 'UserSocialAuth.facebook_access_token'
        db.delete_column('social_auth_usersocialauth', 'facebook_access_token')
    ...
    models = {
        ...
        'social_auth.usersocialauth': {
            ...
            'facebook_extra_data': ('social_auth.fields.JSONField', [], {'default': "'{}'", 'null': 'True', 'blank': 'True'}),
            'facebook_friends': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'facebook_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'twitter_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
