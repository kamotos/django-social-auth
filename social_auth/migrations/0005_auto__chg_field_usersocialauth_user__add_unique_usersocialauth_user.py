...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('social_auth_usersocialauth', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'UserSocialAuth', fields ['user']
        db.create_unique('social_auth_usersocialauth', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserSocialAuth', fields ['user']
        db.delete_unique('social_auth_usersocialauth', ['user_id'])
