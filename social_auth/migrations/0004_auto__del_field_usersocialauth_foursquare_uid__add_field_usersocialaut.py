...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSocialAuth.foursquare_id'
        db.add_column('social_auth_usersocialauth', 'foursquare_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserSocialAuth.foursquare_id'
        db.delete_column('social_auth_usersocialauth', 'foursquare_id')
