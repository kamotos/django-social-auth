...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_auth_usersocialauth', (
            ...
            ('twitter_uid', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True)),
            ('twitter_extra_data', self.gf('social_auth.fields.JSONField')(default='{}', null=True, blank=True)),
        ))
