...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSocialAuth.foursquare_uid'
        db.add_column('social_auth_usersocialauth', 'foursquare_uid',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSocialAuth.foursquare_extra_data'
        db.add_column('social_auth_usersocialauth', 'foursquare_extra_data',
                      self.gf('social_auth.fields.JSONField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSocialAuth.foursquare_uid'
        db.delete_column('social_auth_usersocialauth', 'foursquare_uid')

        # Deleting field 'UserSocialAuth.foursquare_extra_data'
        db.delete_column('social_auth_usersocialauth', 'foursquare_extra_data')
    ...
    models = {
        ...
        'social_auth.usersocialauth': {
            ...
            'foursquare_uid': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
